...
The platform is a [Turborepo](https://turbo.build) monorepo: a Next.js storefront, a React Native buyer app, and a Hono server. Both apps use a shared [oRPC](https://orpc.unnoq.com) client for catalogue, order, and content APIs.
